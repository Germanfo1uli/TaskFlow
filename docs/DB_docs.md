...
- **Attachments - Прикрепляемые файлы к задаче или комментарию.**
- **ProjectTags - Теги для задач в рамках конкретного проекта.**
- **IssueTags - Теги, назначенные определенной задаче.**
